      ...
      <div className="flex-1 p-4 flex flex-col items-center justify-center">
        {isVerified ? (
          <div className="text-center">
            ...
            <p className="text-sm text-zinc-400">Redirection vers l'accueil...</p>
          </div>
        ) : (
          <>
              ...
              <div className="flex justify-between gap-2 mb-6">
                {[0, 1, 2, 3].map((index) => (
                  <input
                    ...
                    className="w-14 h-14 text-center text-xl font-bold bg-zinc-800 border border-zinc-700 rounded-lg focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none"
                  />
                ))}
              </div>
